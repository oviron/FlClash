...
// these exercise that data path: typed edits apply, logical rules stay verbatim,
// order is honoured.
const _doc = '''
mixed-port: 7890
rules:
...
const _logical = 'AND,((DOMAIN,y.com),(NETWORK,UDP)),REJECT';

void main() {
  test('projection splits typed vs logical/MATCH', () {
