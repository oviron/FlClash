...
void main() {
  test(
    'v6 -> v8 upgrade backfills matchMode=all and actionProfileId=null',
    () async {
      ...
      // current (v8) schema first, then we recreate the table at its v6 shape.
      ...
      // Reopen: drift sees user_version 6 and runs onUpgrade(6, 8).
