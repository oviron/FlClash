...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "byedpiTestTitle": MessageLookupByLibrary.simpleMessage("策略测试"),
    "byedpiTestRun": MessageLookupByLibrary.simpleMessage("运行测试"),
    "byedpiTestStop": MessageLookupByLibrary.simpleMessage("停止"),
    "byedpiTestProgress": MessageLookupByLibrary.simpleMessage("测试中"),
    "byedpiTestVpnPaused": MessageLookupByLibrary.simpleMessage("测试期间已暂停 VPN"),
    "byedpiTestSortName": MessageLookupByLibrary.simpleMessage("按名称"),
    "byedpiTestSortDate": MessageLookupByLibrary.simpleMessage("按日期"),
    "byedpiTestFilterAll": MessageLookupByLibrary.simpleMessage("全部"),
    "byedpiTestFilterTested": MessageLookupByLibrary.simpleMessage("已测试"),
    "byedpiTestPrune": MessageLookupByLibrary.simpleMessage("删除低于 40% 的策略"),
    "byedpiTestReset": MessageLookupByLibrary.simpleMessage("重置为默认"),
    "byedpiTestRetest": MessageLookupByLibrary.simpleMessage("重新测试"),
    "byedpiTestRemove": MessageLookupByLibrary.simpleMessage("删除"),
    "byedpiTestApply": MessageLookupByLibrary.simpleMessage("应用"),
    "byedpiTestApplied": MessageLookupByLibrary.simpleMessage("已应用策略"),
    "byedpiTestHint": MessageLookupByLibrary.simpleMessage(
      "运行测试以根据测试站点在您网络中的可达性对策略排序，然后应用最佳策略。",
    ),
