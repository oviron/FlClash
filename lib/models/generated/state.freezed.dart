...
@override@JsonKey() final  ByeDpiSettings byeDpiSettings;
 final  List<String> _byeDpiHostList;
@override@JsonKey() List<String> get byeDpiHostList {
  if (_byeDpiHostList is EqualUnmodifiableListView) return _byeDpiHostList;
  // ignore: implicit_dynamic_type
