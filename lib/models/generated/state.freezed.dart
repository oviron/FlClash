...
mixin _$MakeRealProfileState {
 ...
 String get profilesPath; int get profileId; Map<String, dynamic> get rawConfig; ClashConfig get realPatchConfig; bool get overrideDns; bool get appendSystemDns; List<Rule> get addedRules; String get defaultUA; ByeDpiSettings get byeDpiSettings; List<BypassProfile> get bypassProfiles;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MakeRealProfileState&&(identical(other.profilesPath, profilesPath) || other.profilesPath == profilesPath)&&(identical(other.profileId, profileId) || other.profileId == profileId)&&const DeepCollectionEquality().equals(other.rawConfig, rawConfig)&&(identical(other.realPatchConfig, realPatchConfig) || other.realPatchConfig == realPatchConfig)&&(identical(other.overrideDns, overrideDns) || other.overrideDns == overrideDns)&&(identical(other.appendSystemDns, appendSystemDns) || other.appendSystemDns == appendSystemDns)&&const DeepCollectionEquality().equals(other.addedRules, addedRules)&&(identical(other.defaultUA, defaultUA) || other.defaultUA == defaultUA)&&(identical(other.byeDpiSettings, byeDpiSettings) || other.byeDpiSettings == byeDpiSettings)&&const DeepCollectionEquality().equals(other.bypassProfiles, bypassProfiles));
}


@override
int get hashCode => Object.hash(runtimeType,profilesPath,profileId,const DeepCollectionEquality().hash(rawConfig),realPatchConfig,overrideDns,appendSystemDns,const DeepCollectionEquality().hash(addedRules),defaultUA,byeDpiSettings,const DeepCollectionEquality().hash(bypassProfiles));

@override
String toString() {
  return 'MakeRealProfileState(profilesPath: $profilesPath, profileId: $profileId, rawConfig: $rawConfig, realPatchConfig: $realPatchConfig, overrideDns: $overrideDns, appendSystemDns: $appendSystemDns, addedRules: $addedRules, defaultUA: $defaultUA, byeDpiSettings: $byeDpiSettings, bypassProfiles: $bypassProfiles)';
}
...
@useResult
$Res call({
 String profilesPath, int profileId, Map<String, dynamic> rawConfig, ClashConfig realPatchConfig, bool overrideDns, bool appendSystemDns, List<Rule> addedRules, String defaultUA, ByeDpiSettings byeDpiSettings, List<BypassProfile> bypassProfiles
});


$ClashConfigCopyWith<$Res> get realPatchConfig;$ByeDpiSettingsCopyWith<$Res> get byeDpiSettings;
...
/// Create a copy of MakeRealProfileState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? profilesPath = null,Object? profileId = null,Object? rawConfig = null,Object? realPatchConfig = null,Object? overrideDns = null,Object? appendSystemDns = null,Object? addedRules = null,Object? defaultUA = null,Object? byeDpiSettings = null,Object? bypassProfiles = null,}) {
  return _then(_self.copyWith(
...
as ByeDpiSettings,bypassProfiles: null == bypassProfiles ? _self.bypassProfiles : bypassProfiles // ignore: cast_nullable_to_non_nullable
as List<BypassProfile>,
  ));
}
/// Create a copy of MakeRealProfileState
/// with the given fields replaced by the non-null parameter values.
...
@override
@pragma('vm:prefer-inline')
$ByeDpiSettingsCopyWith<$Res> get byeDpiSettings {
  
  return $ByeDpiSettingsCopyWith<$Res>(_self.byeDpiSettings, (value) {
    return _then(_self.copyWith(byeDpiSettings: value));
  });
}
}
...
@override@JsonKey() final  ByeDpiSettings byeDpiSettings;
 final  List<BypassProfile> _bypassProfiles;
@override@JsonKey() List<BypassProfile> get bypassProfiles {
  if (_bypassProfiles is EqualUnmodifiableListView) return _bypassProfiles;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_bypassProfiles);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MakeRealProfileState&&(identical(other.profilesPath, profilesPath) || other.profilesPath == profilesPath)&&(identical(other.profileId, profileId) || other.profileId == profileId)&&const DeepCollectionEquality().equals(other._rawConfig, _rawConfig)&&(identical(other.realPatchConfig, realPatchConfig) || other.realPatchConfig == realPatchConfig)&&(identical(other.overrideDns, overrideDns) || other.overrideDns == overrideDns)&&(identical(other.appendSystemDns, appendSystemDns) || other.appendSystemDns == appendSystemDns)&&const DeepCollectionEquality().equals(other._addedRules, _addedRules)&&(identical(other.defaultUA, defaultUA) || other.defaultUA == defaultUA)&&(identical(other.byeDpiSettings, byeDpiSettings) || other.byeDpiSettings == byeDpiSettings)&&const DeepCollectionEquality().equals(other._bypassProfiles, _bypassProfiles));
}


@override
int get hashCode => Object.hash(runtimeType,profilesPath,profileId,const DeepCollectionEquality().hash(_rawConfig),realPatchConfig,overrideDns,appendSystemDns,const DeepCollectionEquality().hash(_addedRules),defaultUA,byeDpiSettings,const DeepCollectionEquality().hash(_bypassProfiles));
...
@override $ClashConfigCopyWith<$Res> get realPatchConfig;@override $ByeDpiSettingsCopyWith<$Res> get byeDpiSettings;
...
/// Create a copy of MakeRealProfileState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? profilesPath = null,Object? profileId = null,Object? rawConfig = null,Object? realPatchConfig = null,Object? overrideDns = null,Object? appendSystemDns = null,Object? addedRules = null,Object? defaultUA = null,Object? byeDpiSettings = null,Object? bypassProfiles = null,}) {
...
as List<Rule>,defaultUA: null == defaultUA ? _self.defaultUA : defaultUA // ignore: cast_nullable_to_non_nullable
as String,byeDpiSettings: null == byeDpiSettings ? _self.byeDpiSettings : byeDpiSettings // ignore: cast_nullable_to_non_nullable
as ByeDpiSettings,bypassProfiles: null == bypassProfiles ? _self._bypassProfiles : bypassProfiles // ignore: cast_nullable_to_non_nullable
as List<BypassProfile>,
  ));
}
...
mixin _$MigrationData {
 ...
 Map<String, Object?>? get configMap; List<Rule> get rules; List<Script> get scripts; List<Profile> get profiles; List<ProfileRuleLink> get links; List<NetworkRule> get networkRules;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MigrationData&&const DeepCollectionEquality().equals(other.configMap, configMap)&&const DeepCollectionEquality().equals(other.rules, rules)&&const DeepCollectionEquality().equals(other.scripts, scripts)&&const DeepCollectionEquality().equals(other.profiles, profiles)&&const DeepCollectionEquality().equals(other.links, links)&&const DeepCollectionEquality().equals(other.networkRules, networkRules));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(configMap),const DeepCollectionEquality().hash(rules),const DeepCollectionEquality().hash(scripts),const DeepCollectionEquality().hash(profiles),const DeepCollectionEquality().hash(links),const DeepCollectionEquality().hash(networkRules));

@override
String toString() {
  return 'MigrationData(configMap: $configMap, rules: $rules, scripts: $scripts, profiles: $profiles, links: $links, networkRules: $networkRules)';
}
...
@useResult
$Res call({
 Map<String, Object?>? configMap, List<Rule> rules, List<Script> scripts, List<Profile> profiles, List<ProfileRuleLink> links, List<NetworkRule> networkRules
});
...
/// Create a copy of MigrationData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? configMap = freezed,Object? rules = null,Object? scripts = null,Object? profiles = null,Object? links = null,Object? networkRules = null,}) {
  return _then(_self.copyWith(
...
as List<ProfileRuleLink>,networkRules: null == networkRules ? _self.networkRules : networkRules // ignore: cast_nullable_to_non_nullable
as List<NetworkRule>,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Map<String, Object?>? configMap,  List<Rule> rules,  List<Script> scripts,  List<Profile> profiles,  List<ProfileRuleLink> links,  List<NetworkRule> networkRules)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MigrationData() when $default != null:
return $default(_that.configMap,_that.rules,_that.scripts,_that.profiles,_that.links,_that.networkRules);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Map<String, Object?>? configMap,  List<Rule> rules,  List<Script> scripts,  List<Profile> profiles,  List<ProfileRuleLink> links,  List<NetworkRule> networkRules)  $default,) {final _that = this;
switch (_that) {
case _MigrationData():
return $default(_that.configMap,_that.rules,_that.scripts,_that.profiles,_that.links,_that.networkRules);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Map<String, Object?>? configMap,  List<Rule> rules,  List<Script> scripts,  List<Profile> profiles,  List<ProfileRuleLink> links,  List<NetworkRule> networkRules)?  $default,) {final _that = this;
switch (_that) {
case _MigrationData() when $default != null:
return $default(_that.configMap,_that.rules,_that.scripts,_that.profiles,_that.links,_that.networkRules);case _:
  return null;
...
class _MigrationData implements MigrationData {
  const _MigrationData({final  Map<String, Object?>? configMap, final  List<Rule> rules = const [], final  List<Script> scripts = const [], final  List<Profile> profiles = const [], final  List<ProfileRuleLink> links = const [], final  List<NetworkRule> networkRules = const []}): _configMap = configMap,_rules = rules,_scripts = scripts,_profiles = profiles,_links = links,_networkRules = networkRules;
...
@override@JsonKey() List<ProfileRuleLink> get links {
 ...
 final  List<NetworkRule> _networkRules;
@override@JsonKey() List<NetworkRule> get networkRules {
  if (_networkRules is EqualUnmodifiableListView) return _networkRules;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_networkRules);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MigrationData&&const DeepCollectionEquality().equals(other._configMap, _configMap)&&const DeepCollectionEquality().equals(other._rules, _rules)&&const DeepCollectionEquality().equals(other._scripts, _scripts)&&const DeepCollectionEquality().equals(other._profiles, _profiles)&&const DeepCollectionEquality().equals(other._links, _links)&&const DeepCollectionEquality().equals(other._networkRules, _networkRules));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_configMap),const DeepCollectionEquality().hash(_rules),const DeepCollectionEquality().hash(_scripts),const DeepCollectionEquality().hash(_profiles),const DeepCollectionEquality().hash(_links),const DeepCollectionEquality().hash(_networkRules));
...
/// Create a copy of MigrationData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? configMap = freezed,Object? rules = null,Object? scripts = null,Object? profiles = null,Object? links = null,Object? networkRules = null,}) {
...
as List<ProfileRuleLink>,networkRules: null == networkRules ? _self._networkRules : networkRules // ignore: cast_nullable_to_non_nullable
as List<NetworkRule>,
  ));
}
...
mixin _$SetupState {
 ...
 int? get profileId; int? get profileLastUpdateDate; OverwriteType get overwriteType; List<Rule> get addedRules; Script? get script; bool get overrideDns; Dns get dns; ByeDpiSettings get byeDpiSettings; List<BypassProfile> get bypassProfiles;
...
@override
int get hashCode => Object.hash(runtimeType,profileId,profileLastUpdateDate,overwriteType,const DeepCollectionEquality().hash(addedRules),script,overrideDns,dns,byeDpiSettings,const DeepCollectionEquality().hash(bypassProfiles));

@override
String toString() {
  return 'SetupState(profileId: $profileId, profileLastUpdateDate: $profileLastUpdateDate, overwriteType: $overwriteType, addedRules: $addedRules, script: $script, overrideDns: $overrideDns, dns: $dns, byeDpiSettings: $byeDpiSettings, bypassProfiles: $bypassProfiles)';
}
...
@useResult
$Res call({
 int? profileId, int? profileLastUpdateDate, OverwriteType overwriteType, List<Rule> addedRules, Script? script, bool overrideDns, Dns dns, ByeDpiSettings byeDpiSettings, List<BypassProfile> bypassProfiles
});


$ScriptCopyWith<$Res>? get script;$DnsCopyWith<$Res> get dns;$ByeDpiSettingsCopyWith<$Res> get byeDpiSettings;
...
/// Create a copy of SetupState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? profileId = freezed,Object? profileLastUpdateDate = freezed,Object? overwriteType = null,Object? addedRules = null,Object? script = freezed,Object? overrideDns = null,Object? dns = null,Object? byeDpiSettings = null,Object? bypassProfiles = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? profileId,  int? profileLastUpdateDate,  OverwriteType overwriteType,  List<Rule> addedRules,  Script? script,  bool overrideDns,  Dns dns,  ByeDpiSettings byeDpiSettings,  List<BypassProfile> bypassProfiles)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SetupState() when $default != null:
return $default(_that.profileId,_that.profileLastUpdateDate,_that.overwriteType,_that.addedRules,_that.script,_that.overrideDns,_that.dns,_that.byeDpiSettings,_that.bypassProfiles);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? profileId,  int? profileLastUpdateDate,  OverwriteType overwriteType,  List<Rule> addedRules,  Script? script,  bool overrideDns,  Dns dns,  ByeDpiSettings byeDpiSettings,  List<BypassProfile> bypassProfiles)  $default,) {final _that = this;
switch (_that) {
case _SetupState():
return $default(_that.profileId,_that.profileLastUpdateDate,_that.overwriteType,_that.addedRules,_that.script,_that.overrideDns,_that.dns,_that.byeDpiSettings,_that.bypassProfiles);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? profileId,  int? profileLastUpdateDate,  OverwriteType overwriteType,  List<Rule> addedRules,  Script? script,  bool overrideDns,  Dns dns,  ByeDpiSettings byeDpiSettings,  List<BypassProfile> bypassProfiles)?  $default,) {final _that = this;
switch (_that) {
case _SetupState() when $default != null:
return $default(_that.profileId,_that.profileLastUpdateDate,_that.overwriteType,_that.addedRules,_that.script,_that.overrideDns,_that.dns,_that.byeDpiSettings,_that.bypassProfiles);case _:
  return null;
...
@override
int get hashCode => Object.hash(runtimeType,profileId,profileLastUpdateDate,overwriteType,const DeepCollectionEquality().hash(_addedRules),script,overrideDns,dns,byeDpiSettings,const DeepCollectionEquality().hash(_bypassProfiles));
...
@override $ScriptCopyWith<$Res>? get script;@override $DnsCopyWith<$Res> get dns;@override $ByeDpiSettingsCopyWith<$Res> get byeDpiSettings;
...
/// Create a copy of SetupState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? profileId = freezed,Object? profileLastUpdateDate = freezed,Object? overwriteType = null,Object? addedRules = null,Object? script = freezed,Object? overrideDns = null,Object? dns = null,Object? byeDpiSettings = null,Object? bypassProfiles = null,}) {
