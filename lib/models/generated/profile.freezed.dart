...
mixin _$Profile {
 ...
 int get id; String get label; String? get currentGroupName; String get url; DateTime? get lastUpdateDate; Duration get autoUpdateDuration; SubscriptionInfo? get subscriptionInfo; bool get autoUpdate;// Fetch this subscription as the Happ client (UA + device id) so panels that
// gate their full node set behind Happ serve it in full; off = honest fetch.
 bool get happMode; Map<String, String> get selectedMap; Set<String> get unfoldSet; OverwriteType get overwriteType; int? get scriptId; int? get order; AccessControlProps? get accessControlProps; AppFilterStash? get appFilterStash;
...
@useResult
$Res call({
 int id, String label, String? currentGroupName, String url, DateTime? lastUpdateDate, Duration autoUpdateDuration, SubscriptionInfo? subscriptionInfo, bool autoUpdate, bool happMode, Map<String, String> selectedMap, Set<String> unfoldSet, OverwriteType overwriteType, int? scriptId, int? order, AccessControlProps? accessControlProps, AppFilterStash? appFilterStash
});


$SubscriptionInfoCopyWith<$Res>? get subscriptionInfo;$AccessControlPropsCopyWith<$Res>? get accessControlProps;$AppFilterStashCopyWith<$Res>? get appFilterStash;
...
/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? label = null,Object? currentGroupName = freezed,Object? url = null,Object? lastUpdateDate = freezed,Object? autoUpdateDuration = null,Object? subscriptionInfo = freezed,Object? autoUpdate = null,Object? happMode = null,Object? selectedMap = null,Object? unfoldSet = null,Object? overwriteType = null,Object? scriptId = freezed,Object? order = freezed,Object? accessControlProps = freezed,Object? appFilterStash = freezed,}) {
  return _then(_self.copyWith(
...
as bool,happMode: null == happMode ? _self.happMode : happMode // ignore: cast_nullable_to_non_nullable
...
as int?,accessControlProps: freezed == accessControlProps ? _self.accessControlProps : accessControlProps // ignore: cast_nullable_to_non_nullable
as AccessControlProps?,appFilterStash: freezed == appFilterStash ? _self.appFilterStash : appFilterStash // ignore: cast_nullable_to_non_nullable
as AppFilterStash?,
  ));
}
/// Create a copy of Profile
...
$AccessControlPropsCopyWith<$Res>? get accessControlProps {
    if (_self.accessControlProps == null) {
    return null;
  }
...
@override
@pragma('vm:prefer-inline')
$AppFilterStashCopyWith<$Res>? get appFilterStash {
    if (_self.appFilterStash == null) {
    return null;
  }

  return $AppFilterStashCopyWith<$Res>(_self.appFilterStash!, (value) {
    return _then(_self.copyWith(appFilterStash: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String label,  String? currentGroupName,  String url,  DateTime? lastUpdateDate,  Duration autoUpdateDuration,  SubscriptionInfo? subscriptionInfo,  bool autoUpdate,  bool happMode,  Map<String, String> selectedMap,  Set<String> unfoldSet,  OverwriteType overwriteType,  int? scriptId,  int? order,  AccessControlProps? accessControlProps,  AppFilterStash? appFilterStash)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
return $default(_that.id,_that.label,_that.currentGroupName,_that.url,_that.lastUpdateDate,_that.autoUpdateDuration,_that.subscriptionInfo,_that.autoUpdate,_that.happMode,_that.selectedMap,_that.unfoldSet,_that.overwriteType,_that.scriptId,_that.order,_that.accessControlProps,_that.appFilterStash);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String label,  String? currentGroupName,  String url,  DateTime? lastUpdateDate,  Duration autoUpdateDuration,  SubscriptionInfo? subscriptionInfo,  bool autoUpdate,  bool happMode,  Map<String, String> selectedMap,  Set<String> unfoldSet,  OverwriteType overwriteType,  int? scriptId,  int? order,  AccessControlProps? accessControlProps,  AppFilterStash? appFilterStash)  $default,) {final _that = this;
switch (_that) {
case _Profile():
return $default(_that.id,_that.label,_that.currentGroupName,_that.url,_that.lastUpdateDate,_that.autoUpdateDuration,_that.subscriptionInfo,_that.autoUpdate,_that.happMode,_that.selectedMap,_that.unfoldSet,_that.overwriteType,_that.scriptId,_that.order,_that.accessControlProps,_that.appFilterStash);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String label,  String? currentGroupName,  String url,  DateTime? lastUpdateDate,  Duration autoUpdateDuration,  SubscriptionInfo? subscriptionInfo,  bool autoUpdate,  bool happMode,  Map<String, String> selectedMap,  Set<String> unfoldSet,  OverwriteType overwriteType,  int? scriptId,  int? order,  AccessControlProps? accessControlProps,  AppFilterStash? appFilterStash)?  $default,) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
return $default(_that.id,_that.label,_that.currentGroupName,_that.url,_that.lastUpdateDate,_that.autoUpdateDuration,_that.subscriptionInfo,_that.autoUpdate,_that.happMode,_that.selectedMap,_that.unfoldSet,_that.overwriteType,_that.scriptId,_that.order,_that.accessControlProps,_that.appFilterStash);case _:
  return null;
...
class _Profile implements Profile {
  const _Profile({required this.id, this.label = '', this.currentGroupName, this.url = '', this.lastUpdateDate, required this.autoUpdateDuration, this.subscriptionInfo, this.autoUpdate = true, this.happMode = false, final  Map<String, String> selectedMap = const {}, final  Set<String> unfoldSet = const {}, this.overwriteType = OverwriteType.standard, this.scriptId, this.order, this.accessControlProps, this.appFilterStash}): _selectedMap = selectedMap,_unfoldSet = unfoldSet;
...
// gate their full node set behind Happ serve it in full; off = honest fetch.
@override@JsonKey() final  bool happMode;
...
@override final  AppFilterStash? appFilterStash;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Profile&&(identical(other.id, id) || other.id == id)&&(identical(other.label, label) || other.label == label)&&(identical(other.currentGroupName, currentGroupName) || other.currentGroupName == currentGroupName)&&(identical(other.url, url) || other.url == url)&&(identical(other.lastUpdateDate, lastUpdateDate) || other.lastUpdateDate == lastUpdateDate)&&(identical(other.autoUpdateDuration, autoUpdateDuration) || other.autoUpdateDuration == autoUpdateDuration)&&(identical(other.subscriptionInfo, subscriptionInfo) || other.subscriptionInfo == subscriptionInfo)&&(identical(other.autoUpdate, autoUpdate) || other.autoUpdate == autoUpdate)&&(identical(other.happMode, happMode) || other.happMode == happMode)&&const DeepCollectionEquality().equals(other._selectedMap, _selectedMap)&&const DeepCollectionEquality().equals(other._unfoldSet, _unfoldSet)&&(identical(other.overwriteType, overwriteType) || other.overwriteType == overwriteType)&&(identical(other.scriptId, scriptId) || other.scriptId == scriptId)&&(identical(other.order, order) || other.order == order)&&(identical(other.accessControlProps, accessControlProps) || other.accessControlProps == accessControlProps)&&(identical(other.appFilterStash, appFilterStash) || other.appFilterStash == appFilterStash));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,label,currentGroupName,url,lastUpdateDate,autoUpdateDuration,subscriptionInfo,autoUpdate,happMode,const DeepCollectionEquality().hash(_selectedMap),const DeepCollectionEquality().hash(_unfoldSet),overwriteType,scriptId,order,accessControlProps,appFilterStash);
...
@override $SubscriptionInfoCopyWith<$Res>? get subscriptionInfo;@override $AccessControlPropsCopyWith<$Res>? get accessControlProps;@override $AppFilterStashCopyWith<$Res>? get appFilterStash;
...
/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? label = null,Object? currentGroupName = freezed,Object? url = null,Object? lastUpdateDate = freezed,Object? autoUpdateDuration = null,Object? subscriptionInfo = freezed,Object? autoUpdate = null,Object? happMode = null,Object? selectedMap = null,Object? unfoldSet = null,Object? overwriteType = null,Object? scriptId = freezed,Object? order = freezed,Object? accessControlProps = freezed,Object? appFilterStash = freezed,}) {
