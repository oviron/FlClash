...
@override@JsonKey() final  LogLevel fileLogLevel;
...
class _VpnProps implements VpnProps {
  const _VpnProps({this.enable = true, this.systemProxy = false, this.ipv6 = false, this.allowBypass = false, this.dnsHijacking = true, this.accessControlProps = defaultAccessControlProps});
