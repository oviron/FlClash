...
class $BypassProfilesTable extends BypassProfiles
    with TableInfo<$BypassProfilesTable, BypassProfileRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $BypassProfilesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  static const VerificationMeta _domainsJsonMeta = const VerificationMeta(
    'domainsJson',
  );
  @override
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'bypass_profiles';
  @override
  VerificationContext validateIntegrity(
    Insertable<BypassProfileRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  BypassProfileRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return BypassProfileRow(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
      ...
      domainsJson: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}domains_json'],
      )!,
  ...
  @override
  $BypassProfilesTable createAlias(String alias) {
    return $BypassProfilesTable(attachedDatabase, alias);
  }
}

class BypassProfileRow extends DataClass
    implements Insertable<BypassProfileRow> {
  final int id;
  final String name;
  final bool enabled;
  ...
  BypassProfilesCompanion toCompanion(bool nullToAbsent) {
    return BypassProfilesCompanion(
      id: Value(id),
      name: Value(name),
      enabled: Value(enabled),
  ...
  factory BypassProfileRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  BypassProfileRow copyWithCompanion(BypassProfilesCompanion data) {
    return BypassProfileRow(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
      enabled: data.enabled.present ? data.enabled.value : this.enabled,
      domainsJson: data.domainsJson.present
          ? data.domainsJson.value
          : this.domainsJson,
  ...
  @override
  String toString() {
    return (StringBuffer('BypassProfileRow(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('enabled: $enabled, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, enabled, domainsJson, appsJson, sortOrder);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is BypassProfileRow &&
          other.id == this.id &&
          other.name == this.name &&
          other.enabled == this.enabled &&
...
class BypassProfilesCompanion extends UpdateCompanion<BypassProfileRow> {
  final Value<int> id;
  final Value<String> name;
  final Value<bool> enabled;
  ...
  BypassProfilesCompanion.insert({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
    this.enabled = const Value.absent(),
    this.domainsJson = const Value.absent(),
  ...
  static Insertable<BypassProfileRow> custom({
    Expression<int>? id,
    Expression<String>? name,
    Expression<bool>? enabled,
  ...
  BypassProfilesCompanion copyWith({
    Value<int>? id,
    Value<String>? name,
    Value<bool>? enabled,
  ...
  @override
  String toString() {
    return (StringBuffer('BypassProfilesCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('enabled: $enabled, ')
          ..write('domainsJson: $domainsJson, ')
...
abstract class _$Database extends GeneratedDatabase {
  ...
  late final $BypassProfilesTable bypassProfiles = $BypassProfilesTable(this);
  ...
  late final BypassProfilesDao bypassProfilesDao = BypassProfilesDao(
    this as Database,
  );
  @override
...
typedef $$NetworkRulesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$BypassProfilesTableCreateCompanionBuilder =
    BypassProfilesCompanion Function({
      Value<int> id,
      Value<String> name,
      Value<bool> enabled,
      Value<String> domainsJson,
...
typedef $$BypassProfilesTableUpdateCompanionBuilder =
    BypassProfilesCompanion Function({
      Value<int> id,
      Value<String> name,
      Value<bool> enabled,
...
class $$BypassProfilesTableFilterComposer
    extends Composer<_$Database, $BypassProfilesTable> {
  $$BypassProfilesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BypassProfilesTableOrderingComposer
    extends Composer<_$Database, $BypassProfilesTable> {
  $$BypassProfilesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BypassProfilesTableAnnotationComposer
    extends Composer<_$Database, $BypassProfilesTable> {
  $$BypassProfilesTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BypassProfilesTableTableManager
    extends
        RootTableManager<
          _$Database,
          $BypassProfilesTable,
          ...
          $$BypassProfilesTableOrderingComposer,
          $$BypassProfilesTableAnnotationComposer,
          $$BypassProfilesTableCreateCompanionBuilder,
          $$BypassProfilesTableUpdateCompanionBuilder,
          (
            BypassProfileRow,
            BaseReferences<_$Database, $BypassProfilesTable, BypassProfileRow>,
          ),
          BypassProfileRow,
          PrefetchHooks Function()
        > {
  $$BypassProfilesTableTableManager(_$Database db, $BypassProfilesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$BypassProfilesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$BypassProfilesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$BypassProfilesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> name = const Value.absent(),
...
typedef $$BypassProfilesTableProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      $BypassProfilesTable,
      BypassProfileRow,
...
class $DatabaseManager {
  ...
  $$BypassProfilesTableTableManager get bypassProfiles =>
      $$BypassProfilesTableTableManager(_db, _db.bypassProfiles);
}
...
mixin _$BypassProfilesDaoMixin on DatabaseAccessor<Database> {
  $BypassProfilesTable get bypassProfiles => attachedDatabase.bypassProfiles;
}
