...
abstract class Module {
    ...
    // must perform asynchronous work during install should override
    // onInstallSuspend instead, which is awaited inside the moduleLoader scope
    // without bridging through runBlocking.
