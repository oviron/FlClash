/* Vendored cgo header for libclash.so from oviron/libmihomo-android.
 *
 ...
 *
 * Keep this file in sync with libmihomo's `//export` declarations in
 * src/main/jni/core/lib.go. Bump LIBCLASH_BRIDGE_ABI when adding,
 * removing, or changing a signature.
 */
